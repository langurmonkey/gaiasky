...
# in several different frames of reference: one tied with Jupiter's
# orbit but projected onto the object's orbit; and in the another,
# in which the object orbit is traced onto the plane of the orbit of
# the object itself.
#
