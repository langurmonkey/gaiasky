...
if __name__ == '__main__':
    ...
    if arguments.tag is not None and defs["releasecommands"] is not None:
        ...
        print(" > Upload the files in andromeda.ari.uni-heidelberg.de:/gaiasky/files/releases/ (do not forget update.xml)")
        ...
        print(" > Add new release to gitlab: https://gitlab.com/gaiasky/gaiasky/-/releases")
        ...
        print(" > Update flatpak repo and do pull request. See here: https://gitlab.com/gaiasky/gaiasky/-/issues/337#note_460878130")
