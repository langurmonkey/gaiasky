	...
	public void renderStud(Array<IRenderable> renderables, ICamera camera, double t) {
		if (renderables.size > 0 && renderables.first().getOpacity() > 0) {
			...
			if (curr != null) {
				...
				shaderProgram.setUniformMatrix("u_eclToEq",
						maux.setToRotation(0, 1, 0, -90).mul(Coordinates.equatorialToEclipticF()));
				...
				// dt in seconds
				shaderProgram.setUniformf("u_dt_s",
						(float) (86400d * (currt - ((Orbit) renderables.first()).oc.epoch)));
