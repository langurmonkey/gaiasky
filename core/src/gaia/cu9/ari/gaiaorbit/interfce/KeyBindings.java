...
public class KeyBindings {
    ...
    private void initDefault() {
        ...
        // F1 -> Help dialog
        addMapping(new ProgramAction(txt("action.help"), runnableAbout), Keys.F1);

        // h -> Help dialog
        addMapping(new ProgramAction(txt("action.help"), runnableAbout), Keys.H);

        // Show quit
        final Runnable runnableQuit = () -> EventManager.instance.post(Events.SHOW_QUIT_ACTION);

        // ESCAPE -> Exit
        addMapping(new ProgramAction(txt("action.exit"), runnableQuit), Keys.ESCAPE);

        // q -> Exit
        addMapping(new ProgramAction(txt("action.exit"), runnableQuit), Keys.Q);
        ...
        addMapping(new ProgramAction(txt("action.toggle", txt("element.constellations")), () ->
        ...
        addMapping(new ProgramAction(txt("action.toggle", txt("element.boundaries")), () ->
        ...
        addMapping(new ProgramAction(txt("action.fisheye"), () ->
                EventManager.instance.post(Events.FISHEYE_CMD, !GlobalConf.postprocess.POSTPROCESS_FISHEYE)), Keys.F4);

        // F5 -> take screenshot
        addMapping(new ProgramAction(txt("action.screenshot"), () ->
        ...
        addMapping(new ProgramAction(txt("action.toggle", txt("element.projection")), () -> {
        ...
        addMapping(new ProgramAction(txt("action.starpointsize.inc"), () ->
        ...
        addMapping(new ProgramAction(txt("action.starpointsize.dec"), () ->
        ...
        addMapping(new ProgramAction(txt("action.starpointsize.reset"), () ->
        ...
        addMapping(new ProgramAction(txt("action.search"), runnableSearch, fullGuiCondition), SPECIAL1, Keys.F);

        // f -> Search dialog
        addMapping(new ProgramAction(txt("action.search"), runnableSearch, fullGuiCondition), Keys.F);

        // / -> Search dialog
        addMapping(new ProgramAction(txt("action.search"), runnableSearch, fullGuiCondition), Keys.SLASH);

        // CTRL + SHIFT + O -> Toggle particle fade
        addMapping(new ProgramAction(txt("action.toggle", txt("element.octreeparticlefade")), () ->
                EventManager.instance.post(Events.OCTREE_PARTICLE_FADE_CMD, txt("element.octreeparticlefade"), !GlobalConf.scene.OCTREE_PARTICLE_FADE)), SPECIAL1, SPECIAL2, Keys.O);

        // CTRL + S -> Toggle stereoscopic mode
        addMapping(new ProgramAction(txt("action.toggle", txt("element.stereomode")), () ->
        ...
        addMapping(new ProgramAction(txt("action.switchstereoprofile"), () -> {
        ...
        addMapping(new ProgramAction(txt("action.toggle", txt("element.planetarium")), () ->
