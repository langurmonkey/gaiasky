...
public class DesktopConfInit extends ConfInit {
    ...
    public void persistGlobalConf(File propsFile) {
        ...
        p.setProperty("scene.elevation.type", GlobalConf.scene.ELEVATION_TYPE.toString());
