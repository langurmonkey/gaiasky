...
package gaiasky.render.gdx.mesh;
...
public class VertexBufferObjectWithVAO implements IntVertexData {
    ...
    private void unbindAttributes(ExtShaderProgram shaderProgram) {
