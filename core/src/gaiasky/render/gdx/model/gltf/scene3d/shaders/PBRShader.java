...
import gaiasky.render.gdx.shader.BaseIntShader;
...
public class PBRShader extends DefaultIntShader
{
	...
	public final static Uniform envRotationUniform = new Uniform("u_envRotation", Matrix4Attribute.EnvRotation);
	public final static Setter envRotationSetter = new LocalSetter() {
		...
		public void set (BaseIntShader shader, int inputID, IntRenderable renderable, Attributes combinedAttributes) {
			...
			shader.set(inputID, mat3.set(attribute.value));
		}
	};
	...
	public PBRShader(IntRenderable renderable, Config config, String prefix) {
