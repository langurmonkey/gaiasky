...
import gaiasky.render.gdx.model.gltf.scene3d.attributes.ClippingPlaneAttribute;
import gaiasky.render.gdx.model.gltf.scene3d.attributes.MirrorSourceAttribute;
...
public class MirrorSource implements Disposable
{
	...
	private final ClippingPlaneAttribute clippingPlane = new ClippingPlaneAttribute(Vector3.Y, 0);
