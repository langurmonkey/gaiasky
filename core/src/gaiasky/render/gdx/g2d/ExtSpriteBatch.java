...
import gaiasky.render.gdx.mesh.IntMesh.VertexDataType;
...
public class ExtSpriteBatch implements ExtBatch {
     ...
     *
     * @see ExtSpriteBatch#ExtSpriteBatch(int, ExtShaderProgram)
     */
    public ExtSpriteBatch() {
        this(1000, null);
    }
     ...
     * the ones expect for shaders set with {@link #setShader(ExtShaderProgram)}. See {@link #createDefaultShader()}.
     *
     * @param size          The max number of sprites in a single batch. Max of 8191.
     * @param defaultShader The default shader to use. This is not owned by the SpriteBatch and must be disposed separately.
     */
    public ExtSpriteBatch(int size, ExtShaderProgram defaultShader) {
        ...
        mesh = new IntMesh(vertexDataType, false, size * 4, size * 6,
                new VertexAttribute[] {
    ...
    static public ExtShaderProgram createDefaultShader() {
