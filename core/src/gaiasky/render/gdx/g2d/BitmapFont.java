/*
 * Copyright (c) 2008-2026 Gaia Sky - All rights reserved.
 *  This file is part of Gaia Sky, which is released under the Mozilla Public License 2.0.
 *  You may use, distribute and modify this code under the terms of MPL2.
 *  See the file LICENSE.md in the project root for full license details.
 */

package gaiasky.render.gdx.g2d;
...
import gaiasky.render.gdx.g2d.GlyphLayout.GlyphRun;
...
import static gaiasky.render.gdx.g2d.TextureAtlas.AtlasRegion;
...
public class BitmapFont implements Disposable {
     ...
     */
    public GlyphLayout draw(ExtBatch batch, CharSequence str, float x, float y) {
        cache.clear();
     ...
     */
    public GlyphLayout draw(ExtBatch batch, CharSequence str, float x, float y, float targetWidth, int halign, boolean wrap) {
        cache.clear();
     ...
     * @see BitmapFontCache#addText(CharSequence, float, float, int, int, float, int, boolean, String)
     */
    public void draw(ExtBatch batch, GlyphLayout layout, float x, float y) {
        cache.clear();
