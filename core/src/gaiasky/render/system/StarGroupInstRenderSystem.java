...
public class StarGroupInstRenderSystem extends InstancedRenderSystem implements IObserver {
    protected static final Log logger = Logger.getLogger(StarGroupInstRenderSystem.class);
    ...
    public StarGroupInstRenderSystem(SceneRenderer sceneRenderer, RenderGroup rg, float[] alphas, ExtShaderProgram[] shaders) {
