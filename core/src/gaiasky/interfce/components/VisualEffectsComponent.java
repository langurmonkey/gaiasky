...
public class VisualEffectsComponent extends GuiComponent implements IObserver {
    ...
    protected OwnSliderPlus starBrightness, starSize, starOpacity, ambientLight, labelSize, elevMult;
    ...
    public void initialize() {
        ...
        /** Label size **/
        labelSize = new OwnSliderPlus(I18n.txt("gui.label.size"), Constants.MIN_SLIDER, Constants.MAX_SLIDER, Constants.SLIDER_STEP, Constants.MIN_LABEL_SIZE, Constants.MAX_LABEL_SIZE, skin);
