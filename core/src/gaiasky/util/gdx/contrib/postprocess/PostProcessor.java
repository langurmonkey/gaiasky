...
public final class PostProcessor implements Disposable {
    ...
    public PostProcessor(RenderType rt, boolean useDepth, boolean useAlphaChannel, boolean use32Bits) {
        this(rt, Gdx.graphics.getWidth(), Gdx.graphics.getHeight(), useDepth, useAlphaChannel, use32Bits, false, false, false, false, true);
    }
     ...
     * mode
     */
    public PostProcessor(RenderType rt, int fboWidth, int fboHeight, boolean hasDepth, boolean useAlphaChannel, boolean use32Bits, boolean hasVelocity, boolean hasNormal, boolean hasPosition, boolean hasReflectionMask, boolean preventFloatBuffer) {
        this(rt, fboWidth, fboHeight, hasDepth, useAlphaChannel, use32Bits, hasVelocity, hasNormal, hasPosition, hasReflectionMask, preventFloatBuffer, TextureWrap.ClampToEdge, TextureWrap.ClampToEdge);
    }

    /** Construct a new PostProcessor with the given parameters and the specified texture wrap mode */
    public PostProcessor(RenderType rt, int fboWidth, int fboHeight, boolean useDepth, boolean useAlphaChannel, boolean use32Bits, boolean hasVelocity, boolean hasNormal, boolean hasPosition, boolean hasReflectionMask, boolean preventFloatBuffer, TextureWrap u, TextureWrap v) {
        if (use32Bits) {
            if (useAlphaChannel) {
        ...
        composite = newPingPongBuffer(fboWidth, fboHeight, fbFormat, useDepth, hasVelocity, hasNormal, hasPosition, hasReflectionMask, preventFloatBuffer);
    ...
    public static PingPongBuffer newPingPongBuffer(int width, int height, Format frameBufferFormat, boolean hasDepth) {
        return newPingPongBuffer(width, height, frameBufferFormat, hasDepth, true, false, false, false,  true);
    }
    /**
     * Creates and returns a managed PingPongBuffer buffer, just create and forget. If rebind() is called on context loss, managed
     * PingPongBuffers will be rebound for you.
     ...
     * This is a drop-in replacement for the same-signature PingPongBuffer's constructor.
     */
    public static PingPongBuffer newPingPongBuffer(int width, int height, Format frameBufferFormat, boolean hasDepth, boolean hasVelocity, boolean hasNormal, boolean hasPosition, boolean hasReflectionMask, boolean preventFloatBuffer) {
        PingPongBuffer buffer = new PingPongBuffer(width, height, frameBufferFormat, hasDepth, hasVelocity, hasNormal, hasPosition, hasReflectionMask, preventFloatBuffer);
        buffers.add(buffer);
        return buffer;
    }
