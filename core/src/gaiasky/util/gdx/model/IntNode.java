...
/**
 * A node is part of a hierarchy of Nodes in a {@link IntModel}. A Node encodes a transform relative to its parents. A Node can have
 * child nodes. Optionally a node can specify a {@link IntMeshPart} and a {@link Material} to be applied to the mesh part.
 *
 * @author badlogic
 */
