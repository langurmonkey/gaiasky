...
import gaiasky.util.gdx.g3d.particles.emitters.IntEmitter;
import gaiasky.util.gdx.g3d.particles.influencers.Influencer;
import gaiasky.util.gdx.g3d.particles.renderers.IntParticleControllerRenderer;

public class IntParticleController implements Json.Serializable, ResourceData.Configurable {
	...
	public IntParticleControllerRenderer<?, ?> renderer;
	...
	public IntParticleController(String name, IntEmitter emitter, IntParticleControllerRenderer<?, ?> renderer,
	...
	public IntParticleController copy () {
		IntEmitter emitter = (IntEmitter)this.emitter.copy();
		...
		return new IntParticleController(new String(this.name), emitter, (IntParticleControllerRenderer<?, ?>)renderer.copy(),
			influencers);
	}
	...
	public void write (Json json) {
		...
		json.writeValue("emitter", emitter, IntEmitter.class);
	...
	public void read (Json json, JsonValue jsonMap) {
		...
		emitter = json.readValue("emitter", IntEmitter.class, jsonMap);
		influencers.addAll(json.readValue("influencers", Array.class, Influencer.class, jsonMap));
		renderer = json.readValue("renderer", IntParticleControllerRenderer.class, jsonMap);
	}
