...
public class RegularIntEmitter extends IntEmitter implements Json.Serializable {
	...
	public RegularIntEmitter(RegularIntEmitter regularEmitter) {
		this();
		set(regularEmitter);
	}
	...
	public void set (RegularIntEmitter emitter) {
		super.set(emitter);
	...
	public IntParticleControllerComponent copy () {
		return new RegularIntEmitter(this);
	}
