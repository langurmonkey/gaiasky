...
public class TessellationShaderProgram extends ExtShaderProgram {
    ...
    public TessellationShaderProgram(String vertexShader, String tessellationControlShader, String tessellationEvaluationShader, String fragmentShader) {
        ...
        if (tessellationControlShader == null) throw new IllegalArgumentException("tess control shader must not be null");
        if (tessellationEvaluationShader == null) throw new IllegalArgumentException("tess evaluation shader must not be null");
