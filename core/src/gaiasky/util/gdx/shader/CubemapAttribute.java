...
public class CubemapAttribute extends Attribute {
	...
	public <T extends OwnCubemap> CubemapAttribute(final long type, final TextureDescriptor<T> textureDescription) {
		this(type);
		this.textureDescription.set(textureDescription);
	}

	public CubemapAttribute(final long type, final OwnCubemap texture) {
		this(type);
