...
// */
//public class Matrix4b implements Serializable {
...
//
//    public final static BigDecimal[] stmp = new BigDecimal[16];
//    public final BigDecimal[] tmp = new BigDecimal[16];
//    public final BigDecimal[] val = new BigDecimal[16];
//    private final static MathContext mc = MathContext.DECIMAL128;
//
//    /** Constructs an identity matrix */
//    public Matrix4b() {
//        for (int i = 0; i < 16; i++) {
//            if (i == M00 || i == M11 || i == M22 || i == M33)
//                val[i] = BigDecimal.ONE;
//            else
//                val[i] = BigDecimal.ZERO;
//        }
//    }
//
//    /**
...
//     */
//    public Matrix4b(double[] values) {
//        this.set(values);
//    }
//
//    public Matrix4b(BigDecimal[] values) {
//        this.set(values);
//    }
//
//    public Matrix4b(float[] values) {
//        this.set(values);
//    }
//
//    /**
...
//     */
//    public Matrix4b(Quaterniond quaternion) {
//        this.set(quaternion);
//    }
//
//    /**
...
//     */
//    public Matrix4b(Vector3d position, Quaterniond rotation, Vector3d scale) {
...
//     */
//    public Matrix4b set(Matrix4b matrix) {
//        return this.set(matrix.val);
//    }
//
//    public Matrix4b set(Matrix4 matrix) {
//        return this.set(matrix.val);
//    }
//
//    /**
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b set(double[] values) {
//        for (int i = 0; i < val.length; i++) {
//            val[i] = BigDecimal.valueOf(values[i]);
//        }
//        return this;
//    }
//
//    public Matrix4b set(float[] values) {
//        for (int i = 0; i < val.length; i++) {
//            val[i] = BigDecimal.valueOf(values[i]);
//        }
//        return this;
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b set(Quaterniond quaternion) {
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b set(double quaternionX, double quaternionY, double quaternionZ, double quaternionW) {
...
//     */
//    public Matrix4b set(Vector3d position, Quaterniond orientation) {
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b set(double translationX, double translationY, double translationZ, double quaternionX, double quaternionY, double quaternionZ, double quaternionW) {
...
//
//        val[M00] = BigDecimal.valueOf(1.0f - (yy + zz));
//        val[M01] = BigDecimal.valueOf(xy - wz);
//        val[M02] = BigDecimal.valueOf(xz + wy);
//        val[M03] = BigDecimal.valueOf(translationX);
//
//        val[M10] = BigDecimal.valueOf(xy + wz);
//        val[M11] = BigDecimal.valueOf(1.0f - (xx + zz));
//        val[M12] = BigDecimal.valueOf(yz - wx);
//        val[M13] = BigDecimal.valueOf(translationY);
//
//        val[M20] = BigDecimal.valueOf(xz - wy);
//        val[M21] = BigDecimal.valueOf(yz + wx);
//        val[M22] = BigDecimal.valueOf(1.0f - (xx + yy));
//        val[M23] = BigDecimal.valueOf(translationZ);
//
//        val[M30] = BigDecimal.ZERO;
//        val[M31] = BigDecimal.ZERO;
//        val[M32] = BigDecimal.ZERO;
//        val[M33] = BigDecimal.ONE;
//        return this;
//    }
//
//    /**
...
//     * @return This matrix for chaining
//     */
//    public Matrix4b set(Vector3d position, Quaterniond orientation, Vector3d scale) {
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b set(double translationX, double translationY, double translationZ, double quaternionX, double quaternionY, double quaternionZ, double quaternionW, double scaleX, double scaleY, double scaleZ) {
//        final double xs = quaternionX * 2f, ys = quaternionY * 2f, zs = quaternionZ * 2f;
//        final double wx = quaternionW * xs, wy = quaternionW * ys, wz = quaternionW * zs;
//        final double xx = quaternionX * xs, xy = quaternionX * ys, xz = quaternionX * zs;
//        final double yy = quaternionY * ys, yz = quaternionY * zs, zz = quaternionZ * zs;
//
//        val[M00] = BigDecimal.valueOf(scaleX * (1.0f - (yy + zz)));
//        val[M01] = BigDecimal.valueOf(scaleY * (xy - wz));
//        val[M02] = BigDecimal.valueOf(scaleZ * (xz + wy));
//        val[M03] = BigDecimal.valueOf(translationX);
//
//        val[M10] = BigDecimal.valueOf(scaleX * (xy + wz));
//        val[M11] = BigDecimal.valueOf(scaleY * (1.0f - (xx + zz)));
//        val[M12] = BigDecimal.valueOf(scaleZ * (yz - wx));
//        val[M13] = BigDecimal.valueOf(translationY);
//
//        val[M20] = BigDecimal.valueOf(scaleX * (xz - wy));
//        val[M21] = BigDecimal.valueOf(scaleY * (yz + wx));
//        val[M22] = BigDecimal.valueOf(scaleZ * (1.0f - (xx + yy)));
//        val[M23] = BigDecimal.valueOf(translationZ);
//
//        val[M30] = BigDecimal.ZERO;
//        val[M31] = BigDecimal.ZERO;
...
//     */
//    public Matrix4b set(Vector3d xAxis, Vector3d yAxis, Vector3d zAxis, Vector3d pos) {
//        val[M00] = BigDecimal.valueOf(xAxis.x;
//        val[M01] = BigDecimal.valueOf(xAxis.y;
//        val[M02] = BigDecimal.valueOf(xAxis.z;
//        val[M10] = BigDecimal.valueOf(yAxis.x;
//        val[M11] = BigDecimal.valueOf(yAxis.y;
//        val[M12] = BigDecimal.valueOf(yAxis.z;
//        val[M20] = BigDecimal.valueOf(-zAxis.x;
//        val[M21] = BigDecimal.valueOf(-zAxis.y;
//        val[M22] = BigDecimal.valueOf(-zAxis.z;
//        val[M03] = BigDecimal.valueOf(pos.x;
//        val[M13] = BigDecimal.valueOf(pos.y;
//        val[M23] = BigDecimal.valueOf(pos.z;
//        val[M30] = BigDecimal.ZERO;
//        val[M31] = BigDecimal.ZERO;
//        val[M32] = BigDecimal.ZERO;
//        val[M33] = BigDecimal.ONE;
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b trn(Vector3d vector) {
//        val[M03].add(BigDecimal.valueOf(vector.x));
//        val[M13].add(BigDecimal.valueOf(vector.y));
//        val[M23].add(BigDecimal.valueOf(vector.z));
//        return this;
//    }
//
//    /**
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b trn(double x, double y, double z) {
//        val[M03].add(BigDecimal.valueOf(x));
//        val[M13].add(BigDecimal.valueOf(y));
//        val[M23].add(BigDecimal.valueOf(z));
//        return this;
//    }
//
//    /** @return the backing BigDecimal array */
...
//     */
//    public Matrix4b mul(Matrix4b matrix) {
...
//     * @return This matrix for the purpose of chaining operations together.
//     */
//    public Matrix4b mulLeft(Matrix4b matrix) {
//        tmpMat.set(matrix);
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b setToProjection(double near, double far, double fov, double aspectRatio) {
//        idt();
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b setToOrtho2D(double x, double y, double width, double height) {
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b setToOrtho2D(double x, double y, double width, double height, double near, double far) {
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b setToOrtho(double left, double right, double bottom, double top, double near, double far) {
//
//        this.idt();
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b setTranslation(Vector3d vector) {
//        val[M03] = vector.x;
//        val[M13] = vector.y;
//        val[M23] = vector.z;
//        return this;
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b setTranslation(double x, double y, double z) {
//        val[M03] = x;
//        val[M13] = y;
//        val[M23] = z;
//        return this;
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b setToTranslation(Vector3d vector) {
//        idt();
//        val[M03] = vector.x;
//        val[M13] = vector.y;
//        val[M23] = vector.z;
...
//    }
//
//    public Matrix4b setToTranslation(Vector3 vector) {
//        idt();
//        val[M03] = vector.x;
//        val[M13] = vector.y;
//        val[M23] = vector.z;
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b setToTranslation(double x, double y, double z) {
//        idt();
//        val[M03] = x;
//        val[M13] = y;
//        val[M23] = z;
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b setToTranslationAndScaling(Vector3d translation, Vector3d scaling) {
//        idt();
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b setToTranslationAndScaling(double translationX, double translationY, double translationZ, double scalingX, double scalingY, double scalingZ) {
//        idt();
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b setToRotation(Vector3d axis, double degrees) {
//        if (degrees == 0) {
//            idt();
//            return this;
//        }
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b setToRotationRad(Vector3d axis, double radians) {
//        if (radians == 0) {
//            idt();
//            return this;
//        }
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b setToRotation(double axisX, double axisY, double axisZ, double degrees) {
//        if (degrees == 0) {
//            idt();
//            return this;
//        }
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b setToRotationRad(double axisX, double axisY, double axisZ, double radians) {
//        if (radians == 0) {
//            idt();
//            return this;
//        }
...
//     * @return This matrix for the purpose of chaining methods together
//     */
//    public Matrix4b setToRotation(final Vector3d v1, final Vector3d v2) {
...
//     * @return This matrix for the purpose of chaining methods together
//     */
//    public Matrix4b setToRotation(final double x1, final double y1, final double z1, final double x2, final double y2, final double z2) {
...
//     * @return This matrix
//     */
//    public Matrix4b setFromEulerAngles(double yaw, double pitch, double roll) {
...
//     * @return This matrix for chaining.
//     */
//    public Matrix4b setToScaling(Vector3d vector) {
//        idt();
//        val[M00] = vector.x;
//        val[M11] = vector.y;
//        val[M22] = vector.z;
...
//     * @return This matrix for chaining.
//     */
//    public Matrix4b setToScaling(double x, double y, double z) {
//        idt();
//        val[M00] = x;
//        val[M11] = y;
//        val[M22] = z;
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b setToLookAt(Vector3d direction, Vector3d up) {
...
//    static final Matrix4b tmpMat = new Matrix4b();
//
//    /**
...
//     * @return This matrix
//     */
//    public Matrix4b setToLookAt(Vector3d position, Vector3d target, Vector3d up) {
...
//
//    public Matrix4b setToWorld(Vector3d position, Vector3d forward, Vector3d up) {
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b lerp(Matrix4b matrix, double alpha) {
//        for (int i = 0; i < 16; i++)
...
//     */
//    public Matrix4b set(Matrix3 mat) {
//        val[0] = mat.val[0];
//        val[1] = mat.val[1];
//        val[2] = mat.val[2];
//        val[3] = 0;
...
//    }
//
//    public Matrix4b scl(Vector3d scale) {
//        val[M00] *= scale.x;
//        val[M11] *= scale.y;
//        val[M22] *= scale.z;
//        return this;
//    }
//
//    public Matrix4b scl(double x, double y, double z) {
//        val[M00] *= x;
//        val[M11] *= y;
//        val[M22] *= z;
//        return this;
//    }
//
//    public Matrix4b scl(double scale) {
//        val[M00] *= scale;
//        val[M11] *= scale;
//        val[M22] *= scale;
//        return this;
...
//        return val[Matrix4b.M00] * val[Matrix4b.M00] + val[Matrix4b.M01] * val[Matrix4b.M01] + val[Matrix4b.M02] * val[Matrix4b.M02];
//    }
//
//    /** @return the squared scale factor on the Y axis */
//    public double getScaleYSquared() {
//        return val[Matrix4b.M10] * val[Matrix4b.M10] + val[Matrix4b.M11] * val[Matrix4b.M11] + val[Matrix4b.M12] * val[Matrix4b.M12];
//    }
//
//    /** @return the squared scale factor on the Z axis */
//    public double getScaleZSquared() {
//        return val[Matrix4b.M20] * val[Matrix4b.M20] + val[Matrix4b.M21] * val[Matrix4b.M21] + val[Matrix4b.M22] * val[Matrix4b.M22];
//    }
//
//    /** @return the scale factor on the X axis (non-negative) */
//    public double getScaleX() {
//        return (MathUtilsd.isZero(val[Matrix4b.M01]) && MathUtilsd.isZero(val[Matrix4b.M02])) ? val[Matrix4b.M00] : Math.sqrt(getScaleXSquared());
//    }
//
//    /** @return the scale factor on the Y axis (non-negative) */
//    public double getScaleY() {
//        return (MathUtilsd.isZero(val[Matrix4b.M10]) && MathUtilsd.isZero(val[Matrix4b.M12])) ? val[Matrix4b.M11] : Math.sqrt(getScaleYSquared());
//    }
//
//    /** @return the scale factor on the X axis (non-negative) */
//    public double getScaleZ() {
//        return (MathUtilsd.isZero(val[Matrix4b.M20]) && MathUtilsd.isZero(val[Matrix4b.M21])) ? val[Matrix4b.M22] : Math.sqrt(getScaleZSquared());
//    }
//
...
//    public Matrix4b toNormalMatrix() {
//        val[M03] = 0;
//        val[M13] = 0;
//        val[M23] = 0;
//        return inv().tra();
...
//     * get from {@link Matrix4b#val}. The vector array is assumed to hold a
...
//     * This is the same as {@link Vector3d#prj(Matrix4b)}.
//     *
//     * @param mat the matrix
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b translate(Vector3d translation) {
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b translate(double[] translation) {
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b translate(double x, double y, double z) {
//        tmp[M00] = 1;
//        tmp[M01] = 0;
//        tmp[M02] = 0;
//        tmp[M03] = x;
...
//     * from {@link Matrix4b#val}. This is the same as
//     * {@link Matrix4b#mul(Matrix4b)}.
//     *
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b rotate(Vector3d axis, double degrees) {
//        if (degrees == 0)
//            return this;
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b rotateRad(Vector3d axis, double radians) {
//        if (radians == 0)
//            return this;
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b rotate(double axisX, double axisY, double axisZ, double degrees) {
//        if (degrees == 0)
//            return this;
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b rotateRad(double axisX, double axisY, double axisZ, double radians) {
//        if (radians == 0)
//            return this;
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b rotate(Quaterniond rotation) {
...
//     * @return This matrix for the purpose of chaining methods together
//     */
//    public Matrix4b rotate(final Vector3d v1, final Vector3d v2) {
...
//     * @return This matrix for the purpose of chaining methods together.
//     */
//    public Matrix4b scale(double scaleX, double scaleY, double scaleZ) {
//        tmp[M00] = scaleX;
//        tmp[M01] = 0;
//        tmp[M02] = 0;
//        tmp[M03] = 0;
