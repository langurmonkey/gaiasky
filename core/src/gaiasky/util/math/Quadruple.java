...
public class Quadruple extends Number implements Comparable<Quadruple> {
     ...
     * Deprecated, will be removed in release version. Use {@link Quadruple#EXPONENT_OF_SUBNORMAL} instead
     */
    @Deprecated
     ...
     * Deprecated, will be removed in release version. Use {@link Quadruple#EXPONENT_OF_MIN_NORMAL} instead
     */
    @Deprecated
    ...
    protected void ____Constructors____() {
    ...
    protected void ____Special_values____() {
    } // Just to put a visible mark of the section in the outline view of the IDE
    ...
    public static Quadruple negativeInfinity() {
        return new Quadruple().assignNegativeInfinity();
    }
    ...
    public static Quadruple positiveInfinity() {
        return new Quadruple().assignPositiveInfinity();
    }
    ...
    public static Quadruple ten() {
        return new Quadruple().assign(10);
    }
    ...
    public static Quadruple minValue() {
        return new Quadruple().assignMinValue();
    }
    ...
    public static Quadruple maxValue() {
        return new Quadruple().assignMaxValue();
    }
    ...
    public static Quadruple minNormal() {
        return new Quadruple().assignMinNormal();
    }
    ...
    protected void ____Getters_for_private_fields____() {
    } // Just to put a visible mark of the section in the outline view of the IDE
    ...
    protected void ____Assignments____() {
    } // Just to put a visible mark of the section in the outline view of the IDE
    ...
    protected void ____Conversions____() {
    } // Just to put a visible mark of the section in the outline view of the IDE
    ...
    protected void ____Comparisons____() {
    } // Just to put a visible mark of the section in the outline view of the IDE
    ...
    protected void ________Arithmetic_________() {
    } // Just to put a visible mark of the section in the outline view of the IDE
    ...
    public Quadruple sqrt() {
        ...
        if (absExp % 2 != 0) {                              // Exponent is odd,
            ...
            thirdWord = multed[2];
            if (absExp < 0)
                exponent--;                       // for negative odd powers of two, exp = floor(exp / 2), e.g sqrt(0.64) = 0.8, sqrt(0.36) = 0.6
        }
    ...
    protected void ________Miscellaneous_utility_methods_________() {
    } // Just to put a visible mark of the section in the outline view of the IDE
    ...
    protected void ____Private_fields_____() {
    } // Just to put a visible mark of the section in the outline view of the IDE
    ...
    private static final BigDecimal TWO_RAISED_TO_1E8 = // 2^100_000_000 == BD_TWO.pow(100_000_000, new MathContext(80, RoundingMode.HALF_EVEN)) ==
            ...
            new BigDecimal(
                    "3.6846659369804587632090923909842219150699658122675497084939429616965837768179882661472291330278812763136896778414689207236912875516200052340E+30102999");
    ...
    protected void ____Private_methods___() {
    } // Just to put a visible mark of the section in the outline view of the IDE
    ...
    protected void ____Used_By_ToString___() {
    } // Just to put a visible mark of the section in the outline view of the IDE
    ...
    protected void ____Used_By_Assign_double_v___() {
    } // Just to put a visible mark of the section in the outline view of the IDE
    ...
    protected void ____Used_By_Assign_BigDecimal_v___() {
    } // Just to put a visible mark of the section in the outline view of the IDE
    ...
    protected void ____Used_By_Assign_String_s___() {
    } // Just to put a visible mark of the section in the outline view of the IDE
    ...
    private static class NumberParser {
        ...
        private static void buildQuadruple(NumberParts parts) {
            ...
            if (exceedsAcceptableExponentRange(exp10))
                return;       // exp10 < MIN_EXP10 or exp10 > MAX_EXP10. Assigns corresponding value to the owner in this case.
    ...
    protected void ____Assignments_private____() {
    } // Just to put a visible mark of the section in the outline view of the IDE
    ...
    protected void ____Used_by_conversions____() {
    } // Just to put a visible mark of the section in the outline view of the IDE
    ...
    protected void ____Used_by_arithmetic____() {
    } // Just to put a visible mark of the section in the outline view of the IDE
    ...
    protected void ____Used_By_sqrt____() {
    } // Just to put a visible mark of the section in the outline view of the IDE
