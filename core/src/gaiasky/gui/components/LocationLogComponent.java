        ...
        for (int i = locations.size() - 1; i >= 0; i--) {
            ...
            goToLoc.addListener((event) -> {
                if (event instanceof ChangeEvent) {
                    ...
                    EventManager.publish(Event.CAMERA_POS_CMD, goToLoc, (Object) lr.position.valuesD());
                    EventManager.publish(Event.CAMERA_DIR_CMD, goToLoc, (Object) lr.direction.values());
                    EventManager.publish(Event.CAMERA_UP_CMD, goToLoc, (Object) lr.up.values());
