 ...
 */
public class OrthosphereComponent extends CubemapComponent implements IObserver {
    ...
    protected void setEnumOffset() {
        enumOffset = CubemapProjection.ORTHOSPHERE.ordinal();
    }
    ...
    public void initializeComponent(float componentWidth,
        ...
        var values = ComboBoxBean.getValues(CubemapProjection.getOrthosphereProjections());
        projectionBox.setItems(values);
        projectionBox.setWidth(componentWidth);
        if (projection.isOrthosphere())
