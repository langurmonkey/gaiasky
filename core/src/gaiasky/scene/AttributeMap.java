...
public class AttributeMap {
    ...
    public Map<String, Class<? extends Component>> initialize() {
        ...
        // Trajectory
        putAll(Trajectory.class, "provider", "orbit", "model:Orbit", "pointcolor", "pointsize", "trail", "orbittrail", "newmethod", "onlybody", "numSamples");
        ...
        // ParticleSet
        putAll(ParticleSet.class, "provider:ParticleGroup", "position:ParticleGroup", "datafile", "providerparams", "factor", "profiledecay", "colornoise", "particlesizelimits", "colorMin", "colorMax");
