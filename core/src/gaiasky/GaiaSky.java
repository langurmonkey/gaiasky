...
import gaiasky.util.gdx.shader.loader.*;
...
public final class GaiaSky implements ApplicationListener, IObserver {
    ...
    public void create() {
        ...
        logger.info(I18n.msg("notif.info.compute", (settings.runtime.compute = false && SysUtils.isComputeShaderSupported()) ?
        ...
        assetManager.setLoader(OrientationServer.class, new OrientationServerLoader(dataResolver));
        assetManager.setLoader(ExtShaderProgram.class, new ShaderProgramProvider(internalResolver, ".vertex.glsl", ".fragment.glsl"));
        assetManager.setLoader(ComputeShaderProgram.class, new ComputeShaderLoader(internalResolver));
